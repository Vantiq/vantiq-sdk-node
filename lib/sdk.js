...
//
Vantiq.prototype.select = function(type, props, where, sort) {
...
//
Vantiq.prototype.count = function(type, where) {
...
//
Vantiq.prototype.insert = function(type, object) {
    var path = '/resources/' + type;
...
//
Vantiq.prototype.update = function(type, key, object) {
...
//
Vantiq.prototype.upsert = function(type, object) {
...
//
Vantiq.prototype.delete = function(type, where) {
...
//
Vantiq.prototype.publish = function(topic, message) {
